...
final class SynchronousMethodHandler implements MethodHandler {
  ...
  public Object invoke(Object[] argv) throws Throwable {
    //根据传入的参数，拼装httpurl，feign 的encoder 组件就在这里使用，默认是Spring code
  ...
  Object executeAndDecode(RequestTemplate template, Options options) throws Throwable {
    // 使用HardEncodeTarget 编码Url 参数，
    // 拼接http://serviceA + /say/1
    ...
    try {
      //LoadBalanceFeignClient，不在这个jar包 在spring cloud-open-feign
    ...
    // 在先版本中，封装成了异步任务，使用SpringDecoder组件
